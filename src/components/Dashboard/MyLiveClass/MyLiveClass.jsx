                        ...
                        <div className='w-full'>
                          ...
                          <div class='mt-1 mx-4 flex items-center justify-start gap-2 md:mt-0 ng-tns-c81-0'>
                            ...
                            <a
                              href={lives?.link}
                              target='_blank'
                              class='mr-2 inline-flex cursor-pointer items-center text-[#40A767] underline ng-tns-c81-0'
                            >
                              <span class='mr-2 ng-tns-c81-0'>
                                <svg
                                  width='16'
                                  height='16'
                                  viewBox='0 0 16 16'
                              ...
                              <span class='ng-tns-c81-0'>{lives?.link}</span>
                            </a>
                          </div>
                        </div>
                      </div>
