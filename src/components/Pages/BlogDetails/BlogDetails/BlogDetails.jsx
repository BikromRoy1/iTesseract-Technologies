                  ...
                  <div class='flex flex-wrap items-center p-4 pb-4 sm:p-8'>
                    <div class='mb-4 mr-5 flex items-center md:mr-10'>
                      ...
                      <p class='text-base font-medium text-white'>
                        By
                        <Link to='/team' class='text-white hover:opacity-70'>
                          Abdul Hamid
                        </Link>
                      </p>
                    </div>
              ...
              <div class='-mx-4 flex flex-wrap'>
                <div class='w-full px-4 lg:w-8/12'>
                  <div>
                    ...
                    '
                    >
                      Smart Bangladesh – 100% scholarship Campaign!
                    </h2>
                    <p
                      class='wow fadeInUp mb-8 text-base leading-relaxed text-body-color'
                      data-wow-delay='.1s'
                    >
                      With all the hype and vibe with the Genz generation,
                      iTesseract technologies Ltd. has launched the “100%
                      Scholarship Campaign – Creating Smart Bangladesh ”
                      yesterday 22nd July 2022. As the theme describes already,
                      the campaign is on educating the students on Fourth
                      Industrial Revolution, STEM, Programming, Robotics and
                      Smart System IoT. Aligned with the vision “Smart
                      Bangladesh 2041” this campaign has focused on the
                      perception and expectations of the Genz generation of a
                      future Smart Bangladesh. The range of participants were
                      from Primary, Secondary and Highschool Students. Students
                      from Schools and Colleges like – St. Joseph Higher
                      Secondary School and College, Viqarunnisa Noon,
                      Mastermind, Maple Leaf International school and many
                      others participated in this campaign with a 100%
                      scholarship. The students were given the scholarship based
                      on a technical viva and interviews and were divided into
                      categories by their academic classes. Courses and outcome
                      of this campaign:
                    </p>
                    <p
                      ...
                      data-wow-delay='.1s'
                    >
                      “Children of our Country now have come a long way in
                      technology. It is unbelievable that they are constantly
                      studying advanced technology, developing projects and
                      dreaming big. Yesterday we had an orientation for a new
                      batch of robotics kids in our office. I was truly amazed
                      at the extent of their knowledge. I asked a class two
                      student, why do you want to do this course? He replied: ‘I
                      would like to develop some projects which will help to
                      make smart Bangladesh and i want to inspire new generation
                      to work with technology’ a boy this young thinking about
                      the next generation already stunned me“
                    </p>
                    <h3
                      class='wow fadeInUp mb-8 text-2xl font-bold text-dark sm:text-[26px]'
                      data-wow-delay='.1s'
                    >
                      CEO of iTesseract technologies Ltd
                    </h3>
                    <p
                      class='wow fadeInUp mb-10 text-base leading-relaxed text-body-color'
                      data-wow-delay='.1s'
                    >
                      Adding to that our Senior Educator, Tasnim Jahan has made
                      remarks that “The students were very excited and
                      enthusiastic about the Campaign. They want to utilize this
                      opportunity for their future career. I believe these
                      students will make an effective change in the improvement
                      of our country.” Our Educator, Shakuat Hossain has also
                      commented “They were very much intellect and excited about
                      the campaign program and want to do something for their
                      future”.
                    </p>
                    <div
                      class='wow fadeInUp relative z-10 mb-10 overflow-hidden rounded bg-[#1bb57b] bg-opacity-5 py-8 px-6 text-center sm:p-10 md:px-[60px]'
                      data-wow-delay='.1s
                    '
                    >
                    ...
                    <p
                      ...
                      data-wow-delay='.1s'
                    >
                      Fun part was, each student from a different category was
                      asked to give feedback on their perception on smart
                      Bangladesh and how they want to add to the country and
                      society of Bangladesh in general, and their answers left
                      our jaws dropped. Each answer has unique , innovative
                      individual thoughts on how they want to solve problems
                      with technology and how they want to help our country. We
                      hope to look forward to the lateral part of the campaign
                      and make it a successful event for both the students and
                      our company!
                    </p>
                    <p
                      ...
                      <div class='w-full px-4 md:w-1/2'>
                        ...
                        >
                          <a
                            ...
                            class='mr-2 mb-2 block rounded bg-[#1bb57b] bg-opacity-5 py-2 px-5 text-xs font-medium text-[#1bb57b] hover:bg-opacity-100 hover:text-white md:mr-4 lg:mr-2 xl:mr-4'
                          >
                            Design
                          </a>
                          <a
                          ...
                          <a
                            href='javascript:void(0)'
                            class='mb-2 block rounded bg-[#1bb57b] bg-opacity-5 py-2 px-5 text-xs font-medium text-[#1bb57b] hover:bg-opacity-100 hover:text-white'
                          >
                            Info
                          </a>
                        </div>
                ...
                <div class='w-full px-4 lg:w-4/12'>
                  <div>
                    <div
                      class='wow fadeInUp relative mb-12 overflow-hidden rounded bg-[#009688] py-[60px] px-11 text-center lg:px-8'
                      data-wow-delay='.1s
                    '
                    >
                    ...
                    <div class='-mx-4 mb-8 flex flex-wrap'>
                      <div class='w-full px-4'>
                        ...
                        <span class='mb-10 inline-block h-[2px] w-20 bg-[#1bb57b]'></span>
                      </div>
                        ...
                        >
                          ...
                          <div class='w-full'>
                            <h4>
                              <Link
                                to='/blogs'
                                class='mb-1 inline-block text-lg font-medium leading-snug text-dark hover:text-[#1bb57b] lg:text-base xl:text-lg'
                              >
                                Top easy IDEs for kids to code!
                              </Link>
                            </h4>
                          ...
                          <div class='w-full'>
                            <h4>
                              <Link
                                ...
                                class='mb-1 inline-block text-lg font-medium leading-snug text-dark hover:text-[#1bb57b] lg:text-base xl:text-lg'
                              >
                                Best electronics or IoT kits for kids
                              </Link>
                            </h4>
                            <p class='text-sm text-body-color'>Abdul Hamid</p>
                          </div>
                        </div>
                      </div>
                      <div class='w-full px-4 md:w-1/2 lg:w-full'>
                          ...
                          <div class='w-full'>
                            <h4>
                              <Link
                                ...
                                class='mb-1 inline-block text-lg font-medium leading-snug text-dark hover:text-primary lg:text-base xl:text-lg'
                              >
                                4IR Impact on Education for children
                              </Link>
                            </h4>
                            <p class='text-sm text-body-color'>
                              {' '}
