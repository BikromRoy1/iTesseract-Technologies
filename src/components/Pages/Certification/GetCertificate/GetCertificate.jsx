...
const GetCertificate = () => {
  return (
    <div className='bg-gray-50 py-12'>
      <section className='overflow-hidden  sm:grid sm:grid-cols-2 container mx-auto'>
        <div className='p-8 md:p-12 lg:px-16 lg:py-24'>
          <div className='mx-auto max-w-xl text-center sm:text-left'>
            ...
            <div className='mt-4 md:mt-8'>
              <Link
                to='/registration'
                className='inline-block rounded bg-[#1bb57b] px-12 py-3 text-sm font-medium text-white transition hover:bg-emerald-700 focus:outline-none focus:ring focus:ring-yellow-400'
              >
                ভর্তি হোন এখনি
              </Link>
            </div>
