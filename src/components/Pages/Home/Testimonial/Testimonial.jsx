          ...
          <SwiperSlide>
            <div class='testimonial-item'>
              <p>
                ...
                আমি গাজিপুর থেকে ক্লাসের জন্য ০৬ ঘন্টা বাসে চড়ে আইটেসারেক্টে এসে
                ক্লাস করেছি। আমার জন্য খুব কঠিন ছিল কিন্তু ক্লাসগুলো খুব এনজয়
                করতাম তাই কষ্ট হলেও ক্লাস মিস দিতাম না।
          ...
          <SwiperSlide>
            <div class='testimonial-item'>
              <p>
                ...
                ম্যামের ক্লাসেই গেইম বানিয়েছি ০৩ টি। ম্যাম অনেক যত্ন সহকারে
                আমাদের পড়িয়েছেন। আমি স্ক্রাচ প্রোগ্রামিং ও ব্লক প্রোগ্রামিং
                শিখেছি।
                <FaQuoteRight className='inline-block quote-icon-right' />
              </p>
              <img
