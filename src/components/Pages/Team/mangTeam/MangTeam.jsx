          ...
          {teamMembers?.map((team) => (
            <div class='w-full px-4 sm:w-1/2 lg:w-1/4 xl:w-1/4'>
              <div class='group mb-8 rounded-xl bg-white px-5 pb-10 pt-12 shadow-testimonial dark:bg-dark dark:shadow-none'>
                <div class='relative z-10 mx-auto mb-5 h-[130px] w-[130px]'>
                  <img
                  ...
                  />
                  <span class='absolute bottom-0 left-0 -z-10 h-10 w-10 rounded-full bg-secondary opacity-100 transition-all group-hover:opacity-100'></span>
                  <span class='absolute right-0 top-0 -z-10 opacity-100 transition-all group-hover:opacity-100'>
                    <svg
                      width='55'
                      height='53'
                      viewBox='0 0 55 53'
                ...
                <div class='text-center'>
                  ...
                  <div class='flex items-center justify-center gap-5'>
                    <a
                      ...
                      class='text-[#C3C7D3] hover:text-[#1bb57b]'
                    >
                      <svg
                        width='18'
                        height='18'
